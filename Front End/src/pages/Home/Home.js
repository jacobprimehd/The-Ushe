...
class Home extends Component {
  ...
  render() {
    return (
      ...
      <button type="button" className="btn btn-outline-primary"><a href="/login">Login</a></button>
      <button type="button" className="btn btn-outline-primary"><a href="/register">Register</a></button>
      </div>
    );
  }
}
